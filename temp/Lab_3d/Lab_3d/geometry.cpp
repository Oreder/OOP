...
{
    for(unsigned int i = 0; i<get_dots_count(*dots); i++)
    {
...
{
    switch (choose) {
    case moveOX:    return (double) change.moveOX;
    case moveOY:    return (double) change.moveOY;
    case scale:     return change.scale;
    case angleOX:   return change.angleOX;
    case angleOY:   return change.angleOY;
    default:
        return NULL;
    }
}
